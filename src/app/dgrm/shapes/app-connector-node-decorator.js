...
export class AppConnectorNodeDecorator extends AppShapeEditorDecorator {
	/**
	...
	onTextChange(textEl, updatedProp) {
		...
		const newRadius = ceil(24, 12, Math.sqrt(maxRadiusQrt));
